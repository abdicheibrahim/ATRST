...
{ 
    public interface IUserRepository : IGenericRepository<ApplicationUser>
    {
        ...
        Task<List<ApplicationUser>> GetUsersForAdminAsync(int start, int pageSize, string searchValue = null, string sortColumn = null, string sortDirection = null);
        Task<int> GetUsersCountForAdminAsync(string searchValue = null);
    }
