...
{
    public class ApprovalStatusViewComponent : ViewComponent
    {
        //private readonly IUserAccessService _accessService;
        //private readonly UserManager<ApplicationUser> _userManager;

        //public ApprovalStatusViewComponent(IUserAccessService accessService, UserManager<ApplicationUser> userManager)
        //{
